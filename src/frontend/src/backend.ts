...
import type { Article as _Article, ArticleInput as _ArticleInput, ArticleSummary as _ArticleSummary, ExternalBlob as _ExternalBlob, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async checkArticleExists(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.checkArticleExists(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createArticle(arg0: ArticleInput): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getPendingArticles(): Promise<Array<ArticleSummary>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPendingArticles();
    ...
    async getPublishedArticles(): Promise<Array<ArticleSummary>> {
        if (this.processError) {
            try {
    ...
    async updateArticle(arg0: string, arg1: ArticleInput, arg2: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateArticle(arg0, await to_candid_ArticleInput_n10(this._uploadFile, this._downloadFile, arg1), arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_ArticleSummary_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ArticleSummary): Promise<ArticleSummary> {
...
async function from_candid_opt_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Article]): Promise<Article | null> {
    return value.length === 0 ? null : await from_candid_Article_n14(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        subtitle: record_opt_to_undefined(from_candid_opt_n17(_uploadFile, _downloadFile, value.subtitle))
    };
}
...
async function from_candid_vec_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ArticleSummary>): Promise<Array<ArticleSummary>> {
    return await Promise.all(value.map(async (x)=>await from_candid_ArticleSummary_n22(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        body: value.body,
        slug: value.slug,
        coverImage: await to_candid_ExternalBlob_n12(_uploadFile, _downloadFile, value.coverImage),
        category: value.category,
